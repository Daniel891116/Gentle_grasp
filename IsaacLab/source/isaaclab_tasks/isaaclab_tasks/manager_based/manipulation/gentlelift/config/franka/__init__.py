...
gym.register(
    id="Isaac-GentleLift-Cube-Franka-IK-Abs-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.ik_abs_env_cfg:FrankaCubeGentleLiftEnvCfg",
    },
    disable_env_checker=True,
)
...
gym.register(
    id="Isaac-GentleLift-Cube-Franka-IK-Rel-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    kwargs={
        "env_cfg_entry_point": f"{__name__}.ik_rel_env_cfg:FrankaCubeGentleLiftEnvCfg",
    },
    disable_env_checker=True,
)