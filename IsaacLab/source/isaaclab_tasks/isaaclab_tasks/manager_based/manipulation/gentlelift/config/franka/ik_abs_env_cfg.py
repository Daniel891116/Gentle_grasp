...
import isaaclab_tasks.manager_based.manipulation.gentlelift.mdp as mdp
...
@configclass
class FrankaCubeGentleLiftEnvCfg(joint_pos_env_cfg.FrankaCubeGentleLiftEnvCfg):
...
@configclass
class FrankaCubeGentleLiftEnvCfg(FrankaCubeGentleLiftEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
...
@configclass
class FrankaTeddyBearLiftEnvCfg(FrankaCubeGentleLiftEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
